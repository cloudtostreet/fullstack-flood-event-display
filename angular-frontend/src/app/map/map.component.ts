...
export class MapComponent implements OnInit {
  ...
  floodEventCoordinates: Array<[number, number]> = [
    // Some example values
    [-0.9118598834060469, 8.198836184764517],
    [-0.7118598834060469, 8.298836184764517],
    [-0.9118598834060469, 8.398836184764517],
    [-0.7118598834060469, 8.498836184764517],
  ];
  ...
  ngOnInit(): void {
    ...
    // This is just an example of drawing an outline around a specific region
    // within Ghana. Repurpose it to your needs.
    this.api.ghanaGeometry$.subscribe((ghanaGeometry) => {
      const accraRegion = ghanaGeometry.regions.find(
        (region) => region.name == 'Greater Accra'
      );
